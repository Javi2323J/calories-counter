...
export default function ActivityList({ activities, dispatch }: ActivityListProps): React.JSX.Element {
    ...
    return (
        <>
            ...
            {isEmptyActivities ?
                <p className="text-center my-5">No activities registered yet</p> :
